"""autogenerated by genpy from C66_Grasp/C66_GraspActionResult.msg. Do not edit."""
import sys
...
class C66_GraspActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "C66_Grasp/C66_GraspActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','C66_Grasp/C66_GraspResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(C66_GraspActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = C66_Grasp.msg.C66_GraspResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = C66_Grasp.msg.C66_GraspResult()
