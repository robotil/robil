...
(cl:defmethod cl:initialize-instance :after ((m <RobilTaskResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobilTaskResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name RobilTask-msg:<RobilTaskResult> is deprecated: use RobilTask-msg:RobilTaskResult instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <RobilTaskResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader RobilTask-msg:success-val is deprecated.  Use RobilTask-msg:success instead.")
  (success m))

(cl:ensure-generic-function 'description-val :lambda-list '(m))
(cl:defmethod description-val ((m <RobilTaskResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader RobilTask-msg:description-val is deprecated.  Use RobilTask-msg:description instead.")
  (description m))

(cl:ensure-generic-function 'plan-val :lambda-list '(m))
(cl:defmethod plan-val ((m <RobilTaskResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader RobilTask-msg:plan-val is deprecated.  Use RobilTask-msg:plan instead.")
  (plan m))
