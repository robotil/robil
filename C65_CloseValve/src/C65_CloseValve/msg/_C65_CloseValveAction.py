"""autogenerated by genpy from C65_CloseValve/C65_CloseValveAction.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import C65_CloseValve.msg
import genpy
import actionlib_msgs.msg
import std_msgs.msg

class C65_CloseValveAction(genpy.Message):
  _md5sum = "c29f3d2056fcd9404762cae3b12aba05"
  _type = "C65_CloseValve/C65_CloseValveAction"
...
"""
  ...
  _slot_types = ['C65_CloseValve/C65_CloseValveActionGoal','C65_CloseValve/C65_CloseValveActionResult','C65_CloseValve/C65_CloseValveActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(C65_CloseValveAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = C65_CloseValve.msg.C65_CloseValveActionGoal()
      if self.action_result is None:
        self.action_result = C65_CloseValve.msg.C65_CloseValveActionResult()
      if self.action_feedback is None:
        self.action_feedback = C65_CloseValve.msg.C65_CloseValveActionFeedback()
    else:
      self.action_goal = C65_CloseValve.msg.C65_CloseValveActionGoal()
      self.action_result = C65_CloseValve.msg.C65_CloseValveActionResult()
      self.action_feedback = C65_CloseValve.msg.C65_CloseValveActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_2f.pack(*self.action_goal.goal.location))
      _x = self
      buff.write(_struct_i3I.pack(_x.action_goal.goal.max, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_2f.pack(*self.action_feedback.feedback.location))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.action_goal.goal.location = _struct_2f.unpack(str[start:end])
      _x = self
      start = end
      end += 16
      (_x.action_goal.goal.max, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      self.action_feedback.feedback.location = _struct_2f.unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(self.action_goal.goal.location.tostring())
      _x = self
      buff.write(_struct_i3I.pack(_x.action_goal.goal.max, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      _x = self.action_result.header.frame_id
      length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(self.action_feedback.feedback.location.tostring())
    except struct.error as se: self._check_types(se)
    except TypeError as te: self._check_types(te)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.action_goal.goal.location = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=2)
      _x = self
      start = end
      end += 16
      (_x.action_goal.goal.max, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      ...
      self.action_feedback.feedback.location = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=2)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
