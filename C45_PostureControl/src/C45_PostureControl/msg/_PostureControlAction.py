"""autogenerated by genpy from C45_PostureControl/PostureControlAction.msg. Do not edit."""
import sys
...
import C45_PostureControl.msg

class PostureControlAction(genpy.Message):
  _md5sum = "363ca9cd8121af5f01a2f0b80910f1d6"
  _type = "C45_PostureControl/PostureControlAction"
...
"""
  ...
  _slot_types = ['C45_PostureControl/PostureControlActionGoal','C45_PostureControl/PostureControlActionResult','C45_PostureControl/PostureControlActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PostureControlAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = C45_PostureControl.msg.PostureControlActionGoal()
      if self.action_result is None:
        self.action_result = C45_PostureControl.msg.PostureControlActionResult()
      if self.action_feedback is None:
        self.action_feedback = C45_PostureControl.msg.PostureControlActionFeedback()
    else:
      self.action_goal = C45_PostureControl.msg.PostureControlActionGoal()
      self.action_result = C45_PostureControl.msg.PostureControlActionResult()
      self.action_feedback = C45_PostureControl.msg.PostureControlActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_B3I.pack(_x.action_goal.goal.maintainPosture, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_feedback.feedback.PostureQuality)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.pack(pattern, *self.action_feedback.feedback.PostureQuality))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.maintainPosture, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_B3I.unpack(str[start:end])
      self.action_goal.goal.maintainPosture = bool(self.action_goal.goal.maintainPosture)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      self.action_feedback.feedback.PostureQuality = struct.unpack(pattern, str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(self.action_feedback.feedback.PostureQuality.tostring())
    except struct.error as se: self._check_types(se)
    except TypeError as te: self._check_types(te)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.action_feedback.feedback.PostureQuality = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
