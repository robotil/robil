...
protected:
  ...
  ros::Subscriber _com_subsriber;
  ros::Subscriber _support_polygon_subsriber;
...
public:
	com_error_node(Kinematics::FootSupport support);
	~com_error_node();
	bool result_com_error(C45_PostureControl::com_error::Request  &req,
