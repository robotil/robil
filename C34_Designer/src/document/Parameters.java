...
public class Parameters {
	...
	public static boolean compact_stack_message = true;
	...
	public static boolean set(String key, String value) {
		...
		try {
			...
			if (pfield.getType().getName().equals(String.class.getName())) {
			...
			} else if (pfield.getType().getName().equals(int.class.getName())) {
				pfield.set(null, Integer.parseInt(value));
			} else if (pfield.getType().getName().equals(float.class.getName())) {
				pfield.set(null, Float.parseFloat(value));
			} else if (pfield.getType().getName()
				...
				Log.d("Parameters.set" + key + "," + value
			...
			Log.e("Parameters.set" + key + "," + value
					+ ")  NoSuchFieldException : " + ex.getMessage());
