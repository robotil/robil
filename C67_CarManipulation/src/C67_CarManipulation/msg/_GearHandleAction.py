"""autogenerated by genpy from C67_CarManipulation/GearHandleAction.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import C67_CarManipulation.msg
import genpy
import actionlib_msgs.msg
import std_msgs.msg

class GearHandleAction(genpy.Message):
  _md5sum = "33c969e41d35ed2e028bb20bda16a9c9"
  _type = "C67_CarManipulation/GearHandleAction"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======

GearHandleActionGoal action_goal
GearHandleActionResult action_result
GearHandleActionFeedback action_feedback

================================================================================
MSG: C67_CarManipulation/GearHandleActionGoal
...
================================================================================
MSG: C67_CarManipulation/GearHandleGoal
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
#goal definition
...
================================================================================
MSG: C67_CarManipulation/GearHandleActionResult
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======

Header header
actionlib_msgs/GoalStatus status
GearHandleResult result
...
================================================================================
MSG: C67_CarManipulation/GearHandleResult
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
#result definition
bool success

================================================================================
MSG: C67_CarManipulation/GearHandleActionFeedback
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======

Header header
actionlib_msgs/GoalStatus status
GearHandleFeedback feedback

================================================================================
MSG: C67_CarManipulation/GearHandleFeedback
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
#feedback
bool busy
...
"""
  ...
  _slot_types = ['C67_CarManipulation/GearHandleActionGoal','C67_CarManipulation/GearHandleActionResult','C67_CarManipulation/GearHandleActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GearHandleAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = C67_CarManipulation.msg.GearHandleActionGoal()
      if self.action_result is None:
        self.action_result = C67_CarManipulation.msg.GearHandleActionResult()
      if self.action_feedback is None:
        self.action_feedback = C67_CarManipulation.msg.GearHandleActionFeedback()
    else:
      self.action_goal = C67_CarManipulation.msg.GearHandleActionGoal()
      self.action_result = C67_CarManipulation.msg.GearHandleActionResult()
      self.action_feedback = C67_CarManipulation.msg.GearHandleActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_B3I.pack(_x.action_goal.goal.targetState, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_B.pack(self.action_feedback.feedback.busy))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.targetState, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_B3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.busy,) = _struct_B.unpack(str[start:end])
      self.action_feedback.feedback.busy = bool(self.action_feedback.feedback.busy)
      return self
