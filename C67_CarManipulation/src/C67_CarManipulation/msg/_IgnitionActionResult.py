"""autogenerated by genpy from C67_CarManipulation/IgnitionActionResult.msg. Do not edit."""
import sys
...
class IgnitionActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "C67_CarManipulation/IgnitionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','C67_CarManipulation/IgnitionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(IgnitionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = C67_CarManipulation.msg.IgnitionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = C67_CarManipulation.msg.IgnitionResult()
