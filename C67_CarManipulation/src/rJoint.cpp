		...
		if (callBackRun)
		{
			...
			case 4:
				...
				std::cout<< "angle q4: " << angleVal << " Limits("<< q4rMin << ", "<<
						q4rMax << ")\n";
				IkNext = IkSolution(angleVal, state[q5r], state[q6r], state[q7r],
						state[q8r], state[q9r]);
				break;
			...
			case 5:
				...
				std::cout<< "angle q5: " << angleVal << " Limits("<< q5rMin << ", "<<
						q5rMax << ")\n";
				IkNext = IkSolution(state[q4r], angleVal, state[q6r], state[q7r],
						state[q8r], state[q9r]);
				break;
			...
			case 6:
				...
				std::cout<< "angle q6: " << angleVal << " Limits("<< q6rMin << ", "<<
						q6rMax << ")\n";
				IkNext = IkSolution(state[q4r], state[q5r], angleVal, state[q7r],
						state[q8r], state[q9r]);
				break;
			...
			case 7:
				...
				std::cout<< "angle q7: " << angleVal << " Limits("<< q7rMin << ", "<<
						q7rMax << ")\n";
				IkNext = IkSolution(state[q4r], state[q5r], state[q6r], angleVal,
						state[q8r], state[q9r]);
				break;
			...
			case 8:
				...
				std::cout<< "angle q8: " << angleVal << " Limits("<< q8rMin << ", "<<
						q8rMax << ")\n";
				IkNext = IkSolution(state[q4r], state[q5r], state[q6r], state[q7r],
						angleVal, state[q9r]);
				break;
