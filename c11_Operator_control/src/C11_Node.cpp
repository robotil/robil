...
#include "ros/ros.h"
#include "c11_Operator_control/C11.h"
...
public:
	 ...
	 */
	   ...
	   */
	  bool proccess(c11_Operator_control::C11::Request  &req,
			c11_Operator_control::C11::Response &res )
	  {
...
{
  ros::init(argc, argv, "c11_Operator_control");
  C11_Node my_node();
  while(ros::ok()){
	  ros::spin();
  }
