...
(cl:defmethod cl:initialize-instance :after ((m <RobilTaskFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobilTaskFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name c0_RobilTask-msg:<RobilTaskFeedback> is deprecated: use c0_RobilTask-msg:RobilTaskFeedback instead.")))

(cl:ensure-generic-function 'complete-val :lambda-list '(m))
(cl:defmethod complete-val ((m <RobilTaskFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader c0_RobilTask-msg:complete-val is deprecated.  Use c0_RobilTask-msg:complete instead.")
  (complete m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RobilTaskFeedback>)))
  ...
  "c0_RobilTask/RobilTaskFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RobilTaskFeedback)))
  "Returns string type for a message object of type 'RobilTaskFeedback"
  "c0_RobilTask/RobilTaskFeedback")
