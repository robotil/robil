...
(cl:defmethod cl:initialize-instance :after ((m <RobilTaskGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobilTaskGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name c0_RobilTask-msg:<RobilTaskGoal> is deprecated: use c0_RobilTask-msg:RobilTaskGoal instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <RobilTaskGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader c0_RobilTask-msg:name-val is deprecated.  Use c0_RobilTask-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'uid-val :lambda-list '(m))
(cl:defmethod uid-val ((m <RobilTaskGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader c0_RobilTask-msg:uid-val is deprecated.  Use c0_RobilTask-msg:uid instead.")
  (uid m))

(cl:ensure-generic-function 'parameters-val :lambda-list '(m))
(cl:defmethod parameters-val ((m <RobilTaskGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader c0_RobilTask-msg:parameters-val is deprecated.  Use c0_RobilTask-msg:parameters instead.")
  (parameters m))
