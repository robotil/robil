...
(cl:defmethod cl:initialize-instance :after ((m <TBD>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TBD)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name C24_ObstacleDetection-msg:<TBD> is deprecated: use C24_ObstacleDetection-msg:TBD instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <TBD>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader C24_ObstacleDetection-msg:x-val is deprecated.  Use C24_ObstacleDetection-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <TBD>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader C24_ObstacleDetection-msg:y-val is deprecated.  Use C24_ObstacleDetection-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <TBD>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader C24_ObstacleDetection-msg:z-val is deprecated.  Use C24_ObstacleDetection-msg:z instead.")
  (z m))
