...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<C11-request>)))
  ...
  "2b25868799b5fbdec16e1fbe1938b88d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'C11-request)))
  "Returns md5sum for a message object of type 'C11-request"
  "2b25868799b5fbdec16e1fbe1938b88d")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<C11-request>)))
  ...
  (cl:format cl:nil "~%C11_Agent/C11C32_PATH  path~%~%~%================================================================================~%MSG: C11_Agent/C11C32_PATH~%C11_Agent/pathLocation[] points~%================================================================================~%MSG: C11_Agent/pathLocation~%float64 lat~%float64 lon~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'C11-request)))
  "Returns full string definition for message of type 'C11-request"
  (cl:format cl:nil "~%C11_Agent/C11C32_PATH  path~%~%~%================================================================================~%MSG: C11_Agent/C11C32_PATH~%C11_Agent/pathLocation[] points~%================================================================================~%MSG: C11_Agent/pathLocation~%float64 lat~%float64 lon~%~%"))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<C11-response>)))
  ...
  (cl:format cl:nil "C11_Agent/C34C11_STT  required_stt~%C11_Agent/C32C11_PATH path~%~%~%~%~%================================================================================~%MSG: C11_Agent/C34C11_STT~%int8 stt~%~%~%================================================================================~%MSG: C11_Agent/C32C11_PATH~%C11_Agent/pathLocation[] points~%~%================================================================================~%MSG: C11_Agent/pathLocation~%float64 lat~%float64 lon~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'C11-response)))
  "Returns full string definition for message of type 'C11-response"
  (cl:format cl:nil "C11_Agent/C34C11_STT  required_stt~%C11_Agent/C32C11_PATH path~%~%~%~%~%================================================================================~%MSG: C11_Agent/C34C11_STT~%int8 stt~%~%~%================================================================================~%MSG: C11_Agent/C32C11_PATH~%C11_Agent/pathLocation[] points~%~%================================================================================~%MSG: C11_Agent/pathLocation~%float64 lat~%float64 lon~%~%"))
