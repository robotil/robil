...
class C23Response(genpy.Message):
  _md5sum = "7391d53b821004de5105b6001f7e5ddb"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_8i.pack(_x.objectDetected.ObjectDetected, _x.objectPossition.position.x, _x.objectPossition.position.y, _x.objectPossition.position.z, _x.objectDimensions.x, _x.objectDimensions.y, _x.objectDimensions.width, _x.objectDimensions.height))
    except struct.error as se: self._check_types(se)
    except TypeError as te: self._check_types(te)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.objectDetected.ObjectDetected, _x.objectPossition.position.x, _x.objectPossition.position.y, _x.objectPossition.position.z, _x.objectDimensions.x, _x.objectDimensions.y, _x.objectDimensions.width, _x.objectDimensions.height,) = _struct_8i.unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
class C23(object):
  ...
  _md5sum = 'a6163932e2cb3685869f202f1a98437a'
