"""autogenerated by genpy from C0_RobilTask/RobilTaskAction.msg. Do not edit."""
import sys
...
class RobilTaskAction(genpy.Message):
  _md5sum = "9c2334a3537644a8b893b0a564150ac0"
  _type = "C0_RobilTask/RobilTaskAction"
...
"""
  ...
  _slot_types = ['C0_RobilTask/RobilTaskActionGoal','C0_RobilTask/RobilTaskActionResult','C0_RobilTask/RobilTaskActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RobilTaskAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = C0_RobilTask.msg.RobilTaskActionGoal()
      if self.action_result is None:
        self.action_result = C0_RobilTask.msg.RobilTaskActionResult()
      if self.action_feedback is None:
        self.action_feedback = C0_RobilTask.msg.RobilTaskActionFeedback()
    else:
      self.action_goal = C0_RobilTask.msg.RobilTaskActionGoal()
      self.action_result = C0_RobilTask.msg.RobilTaskActionResult()
      self.action_feedback = C0_RobilTask.msg.RobilTaskActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.action_result.result.success))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_f.pack(self.action_feedback.feedback.complete))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_result.result.success,) = _struct_i.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.complete,) = _struct_f.unpack(str[start:end])
      return self
