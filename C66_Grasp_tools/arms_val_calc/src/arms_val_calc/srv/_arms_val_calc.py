"""autogenerated by genpy from arms_val_calc/arms_val_calcRequest.msg. Do not edit."""
import sys
...
class arms_val_calcRequest(genpy.Message):
  _md5sum = "19fda91e8718638a8d88255cf2ddf6dc"
  _type = "arms_val_calc/arms_val_calcRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(arms_val_calcRequest, self).__init__(*args, **kwds)
...
"""autogenerated by genpy from arms_val_calc/arms_val_calcResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class arms_val_calcResponse(genpy.Message):
  _md5sum = "650273c1955750faa12c370df055c2fb"
  _type = "arms_val_calc/arms_val_calcResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(arms_val_calcResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
_struct_I = genpy.struct_I
_struct_6d = struct.Struct("<6d")
class arms_val_calc(object):
  _type          = 'arms_val_calc/arms_val_calc'
  _md5sum = '211926ed88bd9685e6d894335cff749d'
  _request_class  = arms_val_calcRequest
  _response_class = arms_val_calcResponse
