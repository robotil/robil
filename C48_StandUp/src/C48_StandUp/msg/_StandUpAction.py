"""autogenerated by genpy from C48_StandUp/StandUpAction.msg. Do not edit."""
import sys
...
import genpy
import C48_StandUp.msg
import std_msgs.msg

class StandUpAction(genpy.Message):
  _md5sum = "9ad83620055d6f6bdeba0b0605b3d9de"
  _type = "C48_StandUp/StandUpAction"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======

StandUpActionGoal action_goal
StandUpActionResult action_result
StandUpActionFeedback action_feedback

================================================================================
MSG: C48_StandUp/StandUpActionGoal
...
================================================================================
MSG: C48_StandUp/StandUpGoal
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
# Define the goal
float64 StandUp

================================================================================
MSG: C48_StandUp/StandUpActionResult
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
...
================================================================================
MSG: C48_StandUp/StandUpResult
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
# Define the result
float64 Stand

================================================================================
MSG: C48_StandUp/StandUpActionFeedback
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======

Header header
actionlib_msgs/GoalStatus status
StandUpFeedback feedback

================================================================================
MSG: C48_StandUp/StandUpFeedback
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
...
"""
  ...
  _slot_types = ['C48_StandUp/StandUpActionGoal','C48_StandUp/StandUpActionResult','C48_StandUp/StandUpActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StandUpAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = C48_StandUp.msg.StandUpActionGoal()
      if self.action_result is None:
        self.action_result = C48_StandUp.msg.StandUpActionResult()
      if self.action_feedback is None:
        self.action_feedback = C48_StandUp.msg.StandUpActionFeedback()
    else:
      self.action_goal = C48_StandUp.msg.StandUpActionGoal()
      self.action_result = C48_StandUp.msg.StandUpActionResult()
      self.action_feedback = C48_StandUp.msg.StandUpActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_d3I.pack(_x.action_goal.goal.StandUp, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_d3I.pack(_x.action_result.result.Stand, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.StandUp, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.Stand, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
