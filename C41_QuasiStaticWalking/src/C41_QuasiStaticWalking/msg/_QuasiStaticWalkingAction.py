"""autogenerated by genpy from C41_QuasiStaticWalking/QuasiStaticWalkingAction.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import C41_QuasiStaticWalking.msg
import genpy
import actionlib_msgs.msg
import std_msgs.msg

class QuasiStaticWalkingAction(genpy.Message):
  _md5sum = "1c91742c3db2cec8050d838c4f5fc84c"
  _type = "C41_QuasiStaticWalking/QuasiStaticWalkingAction"
...
"""
  ...
  _slot_types = ['C41_QuasiStaticWalking/QuasiStaticWalkingActionGoal','C41_QuasiStaticWalking/QuasiStaticWalkingActionResult','C41_QuasiStaticWalking/QuasiStaticWalkingActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(QuasiStaticWalkingAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = C41_QuasiStaticWalking.msg.QuasiStaticWalkingActionGoal()
      if self.action_result is None:
        self.action_result = C41_QuasiStaticWalking.msg.QuasiStaticWalkingActionResult()
      if self.action_feedback is None:
        self.action_feedback = C41_QuasiStaticWalking.msg.QuasiStaticWalkingActionFeedback()
    else:
      self.action_goal = C41_QuasiStaticWalking.msg.QuasiStaticWalkingActionGoal()
      self.action_result = C41_QuasiStaticWalking.msg.QuasiStaticWalkingActionResult()
      self.action_feedback = C41_QuasiStaticWalking.msg.QuasiStaticWalkingActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_goal.goal.map)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.map))
      length = len(self.action_goal.goal.path)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.path))
      _x = self
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_f.pack(self.action_feedback.feedback.estimatedTime))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.action_goal.goal.map = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.action_goal.goal.path = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
      ...
      (self.action_feedback.feedback.estimatedTime,) = _struct_f.unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.action_goal.goal.map.tostring())
      length = len(self.action_goal.goal.path)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.action_goal.goal.path.tostring())
      _x = self
      buff.write(_struct_3I.pack(_x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      _x = self.action_result.header.frame_id
      length = len(_x)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.action_goal.goal.map = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.action_goal.goal.path = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      _x = self
      start = end
      end += 12
      (_x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
