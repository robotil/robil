...
# s = arange(-0.5*step_time,0.5*step_time+time_step ,time_step)
...
# p_ref_y = r_[ p_ref0_0y , sigmoid_y/2+step_width/2 ,p_ref1y,-sigmoid_y/2+step_width,p_ref0_0y,-sigmoid_y/2+step_width/2,-p_ref1y+step_width,sigmoid_y/2,p_ref0_0y]#,p_ref1y,+step_width/2,-p_ref1y+step_width,sigmoid_y,p_ref1y ]
