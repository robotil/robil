...
import rospy
import time
from atlas_msgs.msg import AtlasCommand, AtlasSimInterfaceCommand, AtlasSimInterfaceState, AtlasState, AtlasBehaviorStepData, AtlasBehaviorWalkFeedback
...
class Demo:
    ...
    def __init__(self):
        ...
        self.imu_sub = rospy.Subscriber('atlas/imu', 
          Imu, self.imu_cb)
        self.walk_feedback = rospy.Subscriber('/atlas/atlas_behavior_walk_feedback', AtlasBehaviorWalkFeedback, self.walk_feedback_cb)
    ...
    def demo(self):
        ...
        walk_msg.k_effort = [0] * self.NUM_JOINTS#slight_movement_msg.k_effort
        # Publish and give time to take effect
