"""autogenerated by genpy from leg_ik/LegIkRequest.msg. Do not edit."""
import sys
...
"""autogenerated by genpy from leg_ik/LegIkResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class LegIkResponse(genpy.Message):
  _md5sum = "328a48585f80aa570f8bf4ab43f39a9f"
  _type = "leg_ik/LegIkResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LegIkResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.ang is None:
...
class LegIk(object):
  ...
  _request_class  = LegIkRequest
  _response_class = LegIkResponse
