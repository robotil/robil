...
class DW_Controller(object):
    ...
    def __init__(self, arg):
        ...
        self.SitDwnSeq1[1] = -0.3
        self.SitDwnSeq1[6] = self.SitDwnSeq1[6+6] = -1.5
        self.SitDwnSeq1[7] = self.SitDwnSeq1[7+6] = 2.2
        self.SitDwnSeq1[8] = self.SitDwnSeq1[8+6] = -1.2
        self.SitDwnSeq1[16] = self.SitDwnSeq1[16+6] = -1.5
        self.SitDwnSeq1[17] = -0.6
        self.SitDwnSeq1[17+6] = 0.6
        self.SitDwnSeq1[18] = self.SitDwnSeq1[18+6] = 0.6

        self.SitDwnSeq2 = copy(self.SitDwnSeq1)
        self.SitDwnSeq2[1] = 0
        self.SitDwnSeq2[3] = -0.4
        self.SitDwnSeq2[4] = 1.1
        self.SitDwnSeq2[4+6] = -1.1
        # self.SitDwnSeq2[5] = 0.1
        # self.SitDwnSeq2[5+6] = -0.1
        self.SitDwnSeq2[6] = 0
        self.SitDwnSeq2[6+6] = -1.5
        self.SitDwnSeq2[7] = 0
        self.SitDwnSeq2[7+6] = 2.2
        self.SitDwnSeq2[8] = 0
        self.SitDwnSeq2[8+6] = -0.7
        self.SitDwnSeq2[16] = -0.4
        self.SitDwnSeq2[16+6] = -1.5
        self.SitDwnSeq2[17] = 0.3
        self.SitDwnSeq2[17+6] = -0.3
        self.SitDwnSeq2[18] = 0.5
        self.SitDwnSeq2[18+6] = 1.2
        self.SitDwnSeq2[19] = 1.4
        self.SitDwnSeq2[19+6] = -1.4
        ...
        self.ArmSeq2[16] = self.ArmSeq2[16+6] = 0.9
        self.ArmSeq2[17] = -1.7
    ...
    def Sit(self,T):
        self.SeqWithBalance(self.RS.GetJointPos(),self.SitDwnSeq1,T*0.33,0.005)
        rospy.sleep(T*0.33)
        self.JC.send_pos_traj(self.RS.GetJointPos(),self.SitDwnSeq2,T*0.34,0.005)
    ...
    def Run(self,TimeOut = 0):
        ...
        pos1 = copy(self.SitDwnSeq2)
        pos0 = list(self.RS.GetJointPos())
        T=0.5
        ...
        # pos1[17] = -1
        # pos1[19] = 2.2
        # self.JC.send_pos_traj(pos0,pos1,5*T,0.01) 
        ...
        # pos0 = list(self.RS.GetJointPos())
        # pos0[16+6] = pos1[16+6] = -0.4
        # pos1[17+6] = 1
        # pos1[19+6] = -2.2
        # self.JC.send_pos_traj(pos0,pos1,5*T,0.01) 

        # pos0 = list(self.RS.GetJointPos())
        # pos0[16+6] = pos1[16+6] = 0.3
        # pos1[17+6] = -1.4
        # pos1[19+6] = -0.5
        # self.JC.send_pos_traj(pos0,pos1,5*T,0.01) 
        ...
        for x in range(10):
            ...
            pos0[0] = pos1[0] = -0.4
            pos0[4+6] = pos1[4+6] = -1
            # pos0[5+6] = pos1[5+6] = 0.2
            pos1[6+6] = 0
            pos1[7+6] = 0
            pos1[8+6] = 0
            self.JC.send_pos_traj(pos0,pos1,T,0.01) 

            pos0 = list(self.RS.GetJointPos())
            pos0[0] = pos1[0] = -0.4
            pos0[4+6] = pos1[4+6] = -1.1
            # pos0[5+6] = pos1[5+6] = 0
            pos1[6] = -1.5
            pos1[7] = 2.2
            pos1[8] = -0.7
