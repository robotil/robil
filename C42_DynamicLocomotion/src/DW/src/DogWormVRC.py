...
class DW_Controller(object):
    ...
    def DoInvSeqStep(self):
        self.JC.send_pos_traj(self.RS.GetJointPos(),self.RobotCnfg2[self.CurSeqStep],self.StepDur2[self.CurSeqStep],0.005) 
        self.CurSeqStep -= 1
        if self.CurSeqStep < 0:
            self.CurSeqStep = 4
    ...
    def RotateOnSpot(self,Angle):
        ...
        if abs(Angle) < 0.75:
            ...
            N = int(math.floor(abs(Angle)/0.75))
    ...
    def Run(self,TimeOut = 0):
        ...
        # Sequence Step 1: Move pelvis back, closer to arms
        ThisRobotCnfg = copy(self.SitDwnSeq1)
        ThisRobotCnfg[1] = 0.9
        ThisRobotCnfg[6] = ThisRobotCnfg[6+6] = -1.4
        ThisRobotCnfg[7] = ThisRobotCnfg[7+6] = 1.4
        ...
        self.JC.send_pos_traj(self.RS.GetJointPos(),self.RobotCnfg2[0][:],1,0.005)

        # Sequence Step 2: Move COM backwards over the arms and lift legs
        ThisRobotCnfg = copy(self.RobotCnfg[0][:])
        ThisRobotCnfg[1] = 0.5
        ThisRobotCnfg[6] = ThisRobotCnfg[6+6] = -1.6
        ThisRobotCnfg[7] = ThisRobotCnfg[7+6] = 1.4
        ThisRobotCnfg[8] = ThisRobotCnfg[8+6] = 0.8
        ThisRobotCnfg[16] = ThisRobotCnfg[16+6] = 1.3
        ThisRobotCnfg[17] = -0.5
        ThisRobotCnfg[17+6] = 0.5
        ThisRobotCnfg[18] = ThisRobotCnfg[18+6] = 2.6
        ThisRobotCnfg[19] = 1.3
        ThisRobotCnfg[19+6] = -1.3
        self.RobotCnfg2.append(ThisRobotCnfg)
        # self.JC.send_pos_traj(self.RS.GetJointPos(),self.RobotCnfg2[1][:],1,0.005)

        # Sequence Step 2: Move COM backwards over the arms and lift legs
        ThisRobotCnfg = copy(self.RobotCnfg[0][:])
        ThisRobotCnfg[1] = 0.8
        ThisRobotCnfg[6] = ThisRobotCnfg[6+6] = -1.8
        ThisRobotCnfg[7] = ThisRobotCnfg[7+6] = 1.9
        ThisRobotCnfg[8] = ThisRobotCnfg[8+6] = 0.6
        ThisRobotCnfg[16] = ThisRobotCnfg[16+6] = 1.3
        ThisRobotCnfg[17] = -0.9
        ThisRobotCnfg[17+6] = 0.9
        ThisRobotCnfg[18] = ThisRobotCnfg[18+6] = 2.6
        ThisRobotCnfg[19] = 1.1
        ThisRobotCnfg[19+6] = -1.1
        self.RobotCnfg2.append(ThisRobotCnfg)
        self.JC.send_pos_traj(self.RS.GetJointPos(),self.RobotCnfg2[2][:],1,0.005)
        ...
        self.RobotCnfg2.append(ThisRobotCnfg)
        # self.JC.send_pos_traj(self.RS.GetJointPos(),self.RobotCnfg2[2][:],1,0.005)
        # self.JC.send_pos_traj(self.RobotCnfg2[1][:],self.RobotCnfg2[0][:],1,0.005)
