...
class C22Response(genpy.Message):
  _md5sum = "d8c1cda204c382e01f826f53ae67e18d"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_2i6d.pack(_x.drivingPath.xOffset, _x.drivingPath.yOffset, _x.drivingPath.robotPos.x, _x.drivingPath.robotPos.y, _x.drivingPath.robotPos.z, _x.drivingPath.robotOri.x, _x.drivingPath.robotOri.y, _x.drivingPath.robotOri.z))
    except struct.error as se: self._check_types(se)
    except TypeError as te: self._check_types(te)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.drivingPath.xOffset, _x.drivingPath.yOffset, _x.drivingPath.robotPos.x, _x.drivingPath.robotPos.y, _x.drivingPath.robotPos.z, _x.drivingPath.robotOri.x, _x.drivingPath.robotOri.y, _x.drivingPath.robotOri.z,) = _struct_2i6d.unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
